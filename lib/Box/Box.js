...
function (_Component) {
  ...
  _createClass(Box, [{
    ...
    value: function onDismiss() {
      console.log("expanded ".concat(this.state.expanded, " dismissed ").concat(this.state.dismissed));
    ...
    value: function render() {
      ...
      return !dismissed && _react.default.createElement("div", {
        className: "box ".concat(solid ? 'box-solid' : '', " ").concat(color ? "box-".concat(color) : '')
