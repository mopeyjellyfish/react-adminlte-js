...
exports.default = exports.TabHeaderItem = void 0;
...
function (_PureComponent) {
  _inherits(TabHeaderItem, _PureComponent);

  function TabHeaderItem() {
    _classCallCheck(this, TabHeaderItem);

    return _possibleConstructorReturn(this, _getPrototypeOf(TabHeaderItem).apply(this, arguments));
  }
